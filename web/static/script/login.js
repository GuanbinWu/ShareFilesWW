    ...
    const state = {
        ...
        confirm: async function () {
            ...
            if (this.state === "waitLogin") {
                ...
                try {
                    const token = await API.auth_login(account);
                    msg.textContent = "Ok";
            ...
            if (this.state === "regist") {
                ...
                try {
                    const account = { id: 0, username: username_input.value, password: pwd_input.value };
            ...
            if (this.state === "newpwd") {
                ...
                try {
                    const account = { id: 0, username: username_input.value, password: pwd_input.value };
                    const withPWD = { account: account, newpwd: extra_pwd1.value };
